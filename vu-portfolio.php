...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron shadow p-3 mb-5 bg-white rounded" style="margin-top: 40px">
      <div class="row">
        <div class="column "  >
          <img src="img/Assets/skm_kenzie1.jpg" >
          <h5> Shop Sign Kenzie Ukuran 2x1m</h5>
        </div>
        <div class="column" >
          <img src="img/Assets/skm_gatau.jpg">
          <h5> Neon Box @gatau_crb Ukuran 65x65cm</h5>
        </div>
        <div class="column" >
          <img src="img/Assets/skm_kopikita1.jpg">
          <h5> Neon Box Kopi Kita Ukuran 65x65cm 2Muka</h5>
        </div>
        <div class="column" >
          <img src="img/Assets/skm_ulon.jpg">
          <h5> Huruf Timbul Arkem</h5>
        </div>
        <div class="column" >
          <img src="img/Assets/skm_kalula.jpg">
          <h5> Neon Box @kalulacoffee</h5>
        </div>
        <div class="column" >
          <img src="img/Assets/skm_kenzie.jpg">
          <h5> Stand Banner</h5>
        </div>
    </div>
    </div>  
